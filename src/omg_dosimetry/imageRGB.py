...
def load(path, **kwargs):
    ...
    kwargs
        See :class:`~pylinac.core.image.DicomImage`,
        or :class:`~pylinac.core.image.ArrayImage` for keyword arguments.

    Returns
    -------
    ::class:`~omg_dosimetry.imageRGB.FileImage`, :class:`~pylinac.core.image.ArrayImage`, or :class:`~pylinac.core.image.DicomImage`
...
class FileImage(BaseImage):
    ...
    def __init__(self, path, *, dpi=None, sid=None):
        ...
        dpi : int, float
            ...
            .. note:: If a XResolution and YResolution tags is found in the image, that value will override the parameter, 
